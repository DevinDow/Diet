...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { bms: @day.bms, date: @day.date, fitness: @day.fitness, notes: @day.notes, plan: @day.plan } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { bms: @day.bms, date: @day.date, fitness: @day.fitness, notes: @day.notes, plan: @day.plan } }
